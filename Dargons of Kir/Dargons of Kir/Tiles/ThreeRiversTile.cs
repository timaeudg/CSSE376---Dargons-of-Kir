        ...
        public override void placeEffects(Board board)
        {
            ...
            switch (this.orientation)
            {
                case Board.orientation.UP:
                    toAdd.Add(new Effect(Board.makeBoardLocation(this.location.x, (this.location.y + 1) % 8), Board.orientation.LEFT, Board.orientation.DOWN, 0, this.Priority, this));
                    toAdd.Add(new Effect(Board.makeBoardLocation(this.location.x, (this.location.y + 1) % 8), Board.orientation.RIGHT, Board.orientation.DOWN, 0,this.Priority, this));
                ...
                case Board.orientation.LEFT:
                    toAdd.Add(new Effect(Board.makeBoardLocation((this.location.x + 1) % 8, this.location.y), Board.orientation.UP, Board.orientation.RIGHT, 0, this.Priority, this));
                    toAdd.Add(new Effect(Board.makeBoardLocation((this.location.x + 1) % 8, this.location.y), Board.orientation.DOWN, Board.orientation.RIGHT, 0, this.Priority, this));
